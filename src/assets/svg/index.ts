...
import MinusFilledIcon from '@/assets/svg/ic_minus_circle.svg?react';
import MinusUnfilledIcon from '@/assets/svg/ic_minus_circle_unfilled.svg?react';
import MyIcon from '@/assets/svg/ic_my.svg?react';
import NameTagIcon from '@/assets/svg/ic_name_tag.svg?react';
import OriginIcon from '@/assets/svg/ic_origin.svg?react';
